...
export const HomeBanner = ({ onCursor }) => {
  ...
  return (
    <Banner>
      <Video style={{ backgroundImage: `url(/images/${bgImage}.jpg)` }} className='video'>
        <Canvas
          height={size.height}
          width={size.width}
          ref={canvas}
        ...
        <BannerTitle variants={parent} initial='initial' animate='animate'>
          <Headline variants={child} initial='initial' animate='animate'>HYDE</Headline>
          <Headline variants={child} initial='initial' animate='animate'>LAMP</Headline>
        </BannerTitle>
      </Video>
    </Banner>
  )
